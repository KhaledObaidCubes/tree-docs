 ...
 */
export default function evalInContext(code: string, require: (path: string) => any, adaptCreateElement: (h: any) => any, concatenate: (...ags: any[]) => any, h: (...ags: any[]) => any): Record<string, any>;
